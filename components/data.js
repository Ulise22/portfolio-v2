...
export const data = [
...

  {
    ...
    id: 3,
    image: weather,
    visit: 'https://weather-app-iota-sepia.vercel.app',
    github: 'https://github.com/Ulise22/weatherApp',
    descEn: 'I consumed the OpenWeather API to build a fully responsive and functional Weather App in React.',
  ...
  },
  {
    ...
    id: 5,
    image: searcher,
    visit: 'https://images-searcher-xi.vercel.app',
    github: 'https://github.com/Ulise22/images-searcher',
    descEn: 'Made a Images Searcher App with dynamic pagination with React and Css. Consuming the Pixabay restful API.',
    descEs: 'Hice un Buscador de Imágenes con paginación dinámica usando React y Css. Todo esto consumiendo la API de Pixabay.'
  },
  {
    name: 'Calculator',
    id: 6,
    image: calculator,
    visit: 'https://calculator-two-omega.vercel.app/',
    github: 'https://github.com/Ulise22/calculator',
    descEn: 'Build a functional and responsive calculator using React and Css.',
    descEs: 'Construí una aplicación funcional y responsiva de una Calculadora utilizando React y Css.'
  }
]
