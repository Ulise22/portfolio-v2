            ...
            <div className={`${styles.home__container} ${styles.container}`}>
                <div className={styles.home__info}>
                    ...
                    <div className={styles.home__info__icons}>
                        <a href="https://github.com/Ulise22" target="_Blank" className={styles.home__info__icons__item}><i className="fab fa-github fa-3x" /> </a>
                        <a href="https://www.linkedin.com/in/ulisesmontenegro/" target="_Blank" className={styles.home__info__icons__item}><i className="fab fa-linkedin fa-3x" /> </a>
