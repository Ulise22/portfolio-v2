      ...
      <div className={styles.portfolioItem}>
        ...
        <div className={styles.portfolioItem__container}>
          ...
          <div className={styles.portfolioItem__btns}>
            <a href={work.github} target='_Blank' className={styles.portfolio__btns__git} rel='noreferrer'>GitHub</a>
            <a href={work.visit} target='_Blank' className={styles.portfolio__btns__visit} rel='noreferrer'>WebPage</a>
          </div>
        </div>
      </div>
    </div>
